...
export async function up(queryInterface, config, appLog) {
  ...
  await queryInterface.createTable(migrationUtils.tableRef('service_tokens', schema), {
    id: {
  ...
  await queryInterface.addConstraint(migrationUtils.tableRef('service_tokens', schema), {
    type: 'unique',
